...
def convergence_check(measurements, rescale, search_rank, regularization, tolerance, step, trials, num_measurements=500, size=50, rank=5, nesterov=False, momentum=1, max_count=10000, stochastic=False, batch_size=10, grace=0, reg_func=None):
...
def sample_size_experiment(measurements, default_rescale, search_rank, regularization, tolerance, step, trials, lb, ub, jump=100, size=50, rank=5, nesterov=False, momentum=1, max_count=10000, stochastic=False, batch_size=10, grace=0, reg_func=None):
