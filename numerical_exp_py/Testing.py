...
def convergence_check(rescale, search_rank, regularization, tolerance, step, trials, num_measurements=500, size=50, rank=5, default_rescale=1, nesterov=False, momentum=1, max_count=10000, stochastic=False, batch_size=10, grace=0, Thres_1=0, Thres_2=0, Thres_3=0, alt_reg_1=0, alt_reg_2=0, alt_reg_3=0):
    ...
    for _ in range(trials):
        ...
        error, optimized_X, count = optimization_BM_loss_altreg(            
            X_init, 
            measurements, 
            ground_truth_mat,
            step_size=step,
